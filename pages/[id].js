  ...
  return (
    <div className="">
      ...
      <main className="bg-white min-h-screen flex max-w-[1500px] mx-auto">
        ...
        border-gray-100 max-w-2xl sm:ml-[73px] xl:ml-[370px]">
          <div className="bg-white flex items-center px-1.5 py-2 border-b
          border-gray-100 font-bold text-xl gap-x-4 sticky top-0 z-50 opacity-[.98]">
