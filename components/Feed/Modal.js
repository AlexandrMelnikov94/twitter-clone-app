        ...
        <div className="flex items-start justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            ...
            sm:align-middle sm:max-w-xl sm:w-full">
              <div className="flex items-center px-1.5 py-2 border-b border-grey-100">
                  ...
                  <div className="flex gap-x-3 relative">
                    ...
                    <div>
                      <div className=" inline-block group">
                        ...
                        sm:text-base group-hover:underline inline-block">
                          {post?.username}
                        </h4>
                  ...
                  <div className="mt-7 flex space-x-3 w-full">
                    ...
                    <div className="flex-grow mt-2">
                      <textarea
                        ...
                        tracking-wide w-full min-h-[80px] truncate resize-none"
                      />
